...
class TestUtils(unittest.TestCase):
    ...
    def test_is_local_device(self):
        ...
        # When server_per_port is true, the "my_port" passed in is None which
        # means "don't include port in the determination of locality because
        # it's not reliable in this deployment scenario"
        self.assertTrue(is_local_device(my_ips, None,
                                        "127.0.0.1", 6666))
        self.assertTrue(is_local_device(my_ips, None,
                                        "::1", 6666))
