...
class BaseObjectControllerMixin(object):
    ...
    def test_iter_nodes_local_first_noops_when_no_affinity(self):
        ...
        controller = self.controller_cls(
            self.app, 'a', 'c', 'o')
        self.app.get_conf(self.policy).write_affinity_is_local_fn = None
    ...
    def test_iter_nodes_local_first_moves_locals_first(self):
        controller = self.controller_cls(
            self.app, 'a', 'c', 'o')
        policy_conf = self.app.get_conf(self.policy)
    ...
    def _check_write_affinity(
        ...
        object_ring = app.get_object_ring(None)
        # make our fake ring have plenty of nodes, and not get limited
        # artificially by the proxy max request node count
    ...
    def test_write_affinity_proxy_server_config(self):
        ...
        conf = {'write_affinity_node_count': '1 * replicas',
                'write_affinity': 'r0'}
        self._check_write_affinity(conf, {}, POLICIES[0], [0], self.replicas())
        self._check_write_affinity(conf, {}, POLICIES[1], [0], self.replicas())
    ...
    def test_write_affinity_per_policy_config(self):
        ...
        policy_conf = {'0': {'write_affinity_node_count': '1 * replicas',
                             'write_affinity': 'r1'},
                       '1': {'write_affinity_node_count': '2 * replicas',
                             'write_affinity': 'r0'}}
    ...
    def test_write_affinity_per_policy_config_overrides(self):
    ...
    def test_write_affinity_per_policy_config_inherits(self):
        # check that per-policy config will inherit proxy-server section config
        conf = {'write_affinity_node_count': '1 * replicas',
                'write_affinity': 'r0'}
        policy_conf = {'0': {'write_affinity': 'r1'},
                       '1': {'write_affinity_node_count': '2 * replicas'}}
